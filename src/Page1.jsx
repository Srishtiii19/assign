        ...
        <div>
            <div className="cont flex items-center justify-center h-screen">
                <div className="cont1">
                    ...
                    <div className="cont2">
                        <h1 className="title-font mb-2 text-3xl font-medium text-gray-900">Education</h1>
                        <div className="flex py-2">
                            <span className="text-black font-medium text-xl">BTech CSE</span>
                            <span className="ml-auto text-black font-medium text-xl flex items-center">
                                GGSIPU
                                <ul className="list-disc list-inside ml-4 flex items-center space-x-2">
                                    <li className="text-gray-500 dark:text-black">2021-2025</li>
                                </ul>
                            </span>
                        </div>
                        <div className="flex py-2">
                            <span className="text-black font-medium text-xl">XII</span>
                            <span className="ml-auto text-black font-medium text-xl flex items-center">
                                Kendriya Vidyalaya
                                <ul className="list-disc list-inside ml-4 flex items-center space-x-2">
                                    <li className="text-gray-500 dark:text-black">2020-2021</li>
                                </ul>
                            </span>
                        </div>
                    </div>
